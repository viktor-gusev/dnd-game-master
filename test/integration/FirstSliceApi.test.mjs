...
test("identity and campaign APIs respond through the runtime", async () => {
  ...
  try {
    ...
    const res = await fetch(`http://127.0.0.1:${port}/api/identity/local`, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ uuid: "4d8b6f10-4a8b-48f4-b38c-d5128972e289", nickname: "Alice" }) });
